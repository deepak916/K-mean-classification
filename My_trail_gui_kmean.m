function varargout = My_trail_gui_kmean(varargin)
% MY_TRAIL_GUI_KMEAN MATLAB code for My_trail_gui_kmean.fig
...
%      applied to the GUI before My_trail_gui_kmean_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to My_trail_gui_kmean_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help My_trail_gui_kmean
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @My_trail_gui_kmean_OpeningFcn, ...
                   'gui_OutputFcn',  @My_trail_gui_kmean_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before My_trail_gui_kmean is made visible.
function My_trail_gui_kmean_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to My_trail_gui_kmean (see VARARGIN)

% Choose default command line output for My_trail_gui_kmean
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes My_trail_gui_kmean wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = My_trail_gui_kmean_OutputFcn(hObject, eventdata, handles) 
